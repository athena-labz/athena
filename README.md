...
Judges are identified through a public key hash registered as a member of the platform.  DigiServices opens room for new ways of determining good judges; for example neural networks could  be trained to identify good options, rank classifications by specialties or even act as actual judges as a next step development. This abstractness and flexibility creates an incentive for new projects and ideas to emerge and enrich the ecosystem.
